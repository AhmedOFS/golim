"""Shared application-home resolution for cterm."""
...
def resolve_app_home() -> Path:
    """Resolve, create, and bind cterm's application home for this context."""
    app_home = Path.home() / ".cterm"
