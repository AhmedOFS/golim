...
"""LLM interaction module for golim using Ollama's native tool calling"""
import logging
import json
import os
import shlex
...
from golim.core.run_result import RunResult, make_run_result
from golim.config import Config, get_config
from golim.api.chat_api import chat_with_model_api
from golim.logger import log_diagnostic_section
from golim.core.utils import _CONTENT_MARKER, _DIRECT_THINKING_KEYS, _FINAL_SUMMARY_PROMPT, _REASONING_DETAIL_KEYS, _THINKING_KEYS, _TRACE_MARKER, _TRACE_ONLY_MARKER, _clip_label, _clip_text, _detect_python_in_bash, _indent, _run_async
