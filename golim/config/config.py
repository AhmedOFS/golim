"""Configuration and recent-model persistence for golim."""
...
class ConfigSchemaError(ValueError):
    """Raised when an existing config file does not use golim's schema."""


class Config:
    """Read and write golim's single, nested configuration schema.
    ...
    so each running golim instance keeps its own choice while shared
