...
- `AgentUI` is the boundary between `ToolAgent` and presentation. Add new agent-facing UI behavior to `cterm/core/agent_ui.py` and implement it in both `cterm/ui/basic/basic.py` and `cterm/ui/tui/tui.py`.
