...
from openterm.mcp.tools import websearch
...
class WebSearchToolTests(unittest.TestCase):
    ...
    @patch("openterm.mcp.utils.web_utils.get_config", return_value=_config())
    @patch("openterm.mcp.utils.web_utils.requests.post")
    ...
    @patch("openterm.mcp.utils.web_utils.get_config")
    @patch("openterm.mcp.utils.web_utils.requests.post")
    ...
    def test_exa_failure_returns_no_results(self, mock_post, mock_config):
        ...
        from openterm.mcp.tools import NO_RESULTS
